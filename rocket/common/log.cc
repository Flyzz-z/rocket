...
void Logger::init() {
  ...
  // m_timer_event =
  // std::make_shared<TimerEvent>(Config::GetGlobalConfig()->m_log_sync_inteval,
...
void AsyncLogger::stop() { m_stop_flag = true; m_cond.notify_all();}
